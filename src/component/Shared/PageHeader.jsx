        ...
        <div className="flex justify-normal items-center gap-3">
          <div className="relative">
            <input
              ...
              className="border border-gray-300 !rounded-[2px] !py-1 !pl-7 text-gray-700 text-[14px]"
            />
            <MdSearch className="absolute top-2 left-2 text-[16px] text-gray-600" />
          </div>

          <select
            value={selectedFilter}
            onChange={(e) => setSelectedFilter(e.target.value)}
            className="border border-gray-300 !rounded-l-[2px] !py-1 !px-1.5 text-gray-700 text-[14px]">
